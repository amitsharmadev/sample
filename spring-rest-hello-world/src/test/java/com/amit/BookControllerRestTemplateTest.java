...
public class BookControllerRestTemplateTest {
    ...
    @Before
    public void init() {
        Book book = new Book(1L, "Book Name", "Amit", new BigDecimal("9.99"));
    ...
    public void find_bookId_OK() throws JSONException {
        ...
        String expected = "{id:1,name:\"Book Name\",author:\"Amit\",price:9.99}";
    ...
    public void save_book_OK() throws Exception {
        ...
        Book newBook = new Book(1L, "Spring Boot Guide", "amit", new BigDecimal("2.99"));
    ...
    public void update_book_OK() throws Exception {
        ...
        Book updateBook = new Book(1L, "ABC", "amit", new BigDecimal("19.99"));
